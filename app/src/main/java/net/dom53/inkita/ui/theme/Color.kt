...
val ShelfPrimary = Color(0xFF8B74E8)
val ShelfPrimaryBright = Color(0xFFA18FFF)
val ShelfSecondary = Color(0xFF9E8CD6)
val ShelfAccent = Color(0xFFE1A38D)

val ShelfOnSurface = Color(0xFFECEFF4)
val ShelfOnSurfaceMuted = Color(0xFF9AA4B2)

val ShelfError = Color(0xFFDA3633)
...
val ShelfLightPrimary = Color(0xFF553E98)
